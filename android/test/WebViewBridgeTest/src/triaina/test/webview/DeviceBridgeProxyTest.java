...
public class DeviceBridgeProxyTest extends AndroidTestCase {
    ...
    private BridgeConfig mConfig1;
    private BridgeConfig mConfig2;
    ...
    protected void setUp() throws Exception {
        ...
        mConfig1 = new BridgeConfig();
        mBridge1 = new DeviceBridge1();
        mConfig1.add(new BridgeMethodConfig("aaa", mBridge1.getClass().getMethod("aaa",
                new Class[] { MockParams.class })));
        mConfig1.add(new BridgeMethodConfig("bbb", mBridge1.getClass().getMethod("bbb",
                new Class[] { MockParams.class, Callback.class })));
        mConfig1.add(new BridgeMethodConfig("ccc", mBridge1.getClass().getMethod("ccc",
                new Class[] { MockParams.class, Callback.class })));

        mConfig2 = new BridgeConfig();
        mBridge2 = new DeviceBridge2();
        mConfig2.add(new BridgeMethodConfig("ddd", mBridge2.getClass().getMethod("ddd", new Class[] {})));
    }
    ...
    public void testNotifyToDevice() throws Exception {
        ...
        proxy.notifyToDevice("{'bridge':'" + WebViewBridge.VERSION
                + "', 'dest':'aaa', 'params':{'aaa':'aaa', 'bbb': 'bbb'}}");
    ...
    public void testNotifyToDeviceUseCallback() throws Exception {
        ...
        proxy.addBridgeObjectConfig(mBridge1, mConfig1);
        proxy.notifyToDevice("{'bridge':'" + WebViewBridge.VERSION
                + "', 'id': '1', 'dest':'bbb', 'params':{'aaa':'aaa', 'bbb': 'bbb'}}");
    ...
    public void testNotifyToDeviceUseDummyCallback() throws Exception {
        ...
        proxy.addBridgeObjectConfig(mBridge1, mConfig1);
        proxy.notifyToDevice("{'bridge':'" + WebViewBridge.VERSION
                + "', 'dest':'ccc', 'params':{'aaa':'aaa', 'bbb': 'bbb'}}");
