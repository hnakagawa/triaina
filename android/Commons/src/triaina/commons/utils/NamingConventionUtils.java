...
public final class NamingConventionUtils {
    ...
    /**
     * Convert the name of an enum as given in a JSON string to its Java
     * identifier name, as per JSON and Java conventions. (e.g. "some_enum" to
     * "SOME_ENUM")
     * 
     * @param enumJsonName
     *            the enum name as given in the JSON string
     * @return the same enum converted as a proper Java identifier name
     * @throws NullPointerException
     *             if {@link enumJsonName} is null
     */
