...
public class NotificationBridge implements BridgeLifecyclable {
    ...
    static {
        ...
        ICON_MAP.append("close".hashCode(), android.R.drawable.ic_menu_close_clear_cancel);
        ICON_MAP.append("compass".hashCode(), android.R.drawable.ic_menu_compass);
        ...
        ICON_MAP.append("directions".hashCode(), android.R.drawable.ic_menu_directions);
        ICON_MAP.append("edit".hashCode(), android.R.drawable.ic_menu_edit);
        ICON_MAP.append("gallery".hashCode(), android.R.drawable.ic_menu_gallery);
        ICON_MAP.append("help".hashCode(), android.R.drawable.ic_menu_help);
        ICON_MAP.append("info".hashCode(), android.R.drawable.ic_menu_info_details);
        ...
        ICON_MAP.append("calendar".hashCode(), android.R.drawable.ic_menu_my_calendar);
        ICON_MAP.append("location".hashCode(), android.R.drawable.ic_menu_mylocation);
        ICON_MAP.append("places".hashCode(), android.R.drawable.ic_menu_myplaces);
        ICON_MAP.append("preferences".hashCode(), android.R.drawable.ic_menu_preferences);
        ICON_MAP.append("history".hashCode(), android.R.drawable.ic_menu_recent_history);
        ICON_MAP.append("image".hashCode(), android.R.drawable.ic_menu_report_image);
        ...
        ICON_MAP.append("slideshow".hashCode(), android.R.drawable.ic_menu_slideshow);
    ...
    public void nofity(NotificationNotifyParams params, Callback<NotificationResult> callback) {
        Intent intent = new Intent();
        intent.setClassName(mContext.getPackageName(), mContext.getPackageName() + "." + params.getView());
        intent.putExtra(VALUE_KEY, params.getValue());

        PendingIntent pendingIntent = PendingIntent.getActivity(mContext, DEFAULT_CODE, intent,
                Intent.FLAG_ACTIVITY_NEW_TASK);

        Notification notification = new NotificationCompat.Builder(mContext).setContentTitle(params.getTitle())
                .setContentText(params.getText()).setSmallIcon(ICON_MAP.get(params.getIcon().hashCode()))
