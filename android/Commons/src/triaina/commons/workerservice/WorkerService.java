...
public class WorkerService extends AbstractIntentService {
    ...
    public boolean onHandleIntent(Intent intent, int retry, int delayAmount) {
        ...
        try {
            ...
            return worker.process(job, retry, delayAmount, (ResultReceiver) intent.getParcelableExtra(EXTRA_RECEIVER),
                    this, getHandler());
        } catch (Exception exp) {
    ...
    protected static void buildIntent(Class<? extends WorkerService> clazz, Intent intent, Context context, Job job,
