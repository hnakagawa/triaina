...
public class ViewUtils {
    ...
    /**
     * Set the displayed child of an animator view by the view resource ID. If
     * the animator has no child with the given resource ID, nothing happens.
     * 
     * @param animator
     *            the animator the view to display is in. Must not be null
     * @param viewResource
     *            the resource ID of the view to display
     */
