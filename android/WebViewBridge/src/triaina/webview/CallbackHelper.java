...
public class CallbackHelper {
    ...
    public void invokeSucceed(WebViewBridge bridge, Callback<Result> callback, JSONObject json)
    ...
    public Class<?> getResultClass(Callback<?> callback) {
        ...
        for (Method method : methods) {
            ...
            if (geneTypes.length == 2 && params.length == 2 && !Result.class.equals(geneTypes[1])
                    && Result.class.isAssignableFrom(params[1]))
                return params[1];
        }
