...
public class JSONConverterTest extends TestCase {
    ...
    public void testToObjectTest1() throws Exception {
        Test1 t1 = JSONConverter.toObject(
                "{'aaa_aaa': 'aaa', 'bbb_bbb': 1.1, 'ccc_ccc' : 1, 'ddd_ddd' : true, 'exclusion' : 'test'}",
                Test1.class);
    ...
    public void testToObjectTest2() throws Exception {
        Test2 t2 = JSONConverter.toObject("{'aaa_aaa': 'aaa', 'child' : {'bbb_bbb' : 'bbb'}}", Test2.class);
        assertEquals("aaa", t2.mAaaAaa);
        assertEquals("bbb", t2.mChild.mBbbBbb);
    }

    public void testToObjectTest2ChildEmpty() throws Exception {
        final Test2 t2 = JSONConverter.toObject("{'aaa_aaa': 'aaa'}", Test2.class);
        assertEquals("aaa", t2.mAaaAaa);
        assertNull(t2.mChild);
    }

    /**
     * Tests behavior when inflating JSON data with keys which don't match
     * members in the destination object. Expected behavior : only superfluous
     * data will be ignored and no exception is thrown by the inflation process.
     */
    public void testToObjectTest2SuperfluousJsonData() throws Exception {
        final Test2 t2 = JSONConverter.toObject(
                "{'aaa_aaa': 'aaa', 'aaa_aab':'ignored', 'child' : {'xxx':'ignored', 'bbb_bbb' : 'bbb'}}", Test2.class);
        assertEquals("aaa", t2.mAaaAaa);
    ...
    public void testConversionNull() throws JSONConvertException, JSONException {
        // -- test with a String member variable - not specified in the JSON
        // data
        ...
        // -- test with a String member variable - explicitly specified as NULL
        // in the JSON data
    ...
    // both classes must be public and the outer one static to be instantiable
    // from the JSON conversion library
    ...
    public void testConversionObjectInnerClass() throws JSONConvertException, JSONException {
        ...
        final String jsonData = "{" + "'inner_class':{'text_member':'" + innerClassTextMember + "'}" + ", "
        ...
        final EncapsulatingClass voidConvertionResult = JSONConverter
                .toObject(VOID_JSON_DATA, EncapsulatingClass.class);
        ...
        assertTrue(JSONObjectUtils.areDataEquivalent(jsonDataObject, toJsonConversionResult)); // JSONObject#equals
                                                                                               // isn't
                                                                                               // implemented
    }
    ...
    public void testConversionObjectArray() throws JSONConvertException, JSONException {
        ...
        final String arrayJsonData = "[" + "{bbb_bbb:" + "'" + arrayJsonDataValue01 + "'" + "}" + "," + // [0]
                "null" + "," + // [1]
    ...
    public void testConversionNumberArray() throws JSONException, JSONConvertException {
        ...
        final String arrayJsonData = "[" + arrayJsonDataValue01 + "," + // [0]
                "null" + "," + // [1]
        ...
        assertEquals(arrayJsonDataArray.getDouble(4), toJsonArrayConversionResult.getDouble(4)); // automatically
                                                                                                 // coerced
                                                                                                 // from
                                                                                                 // String
        ...
        // Java object <-> JSON
        final Float[] toFloatArrayFromConvertedArrayConversionResult = JSONConverter.toObjectArray(
                toJsonArrayConversionResult, Float.class);
